      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
        ...
        <div className="flex flex-col gap-6 text-lg leading-relaxed text-muted">
          ...
          <div className="mt-4 grid grid-cols-3 gap-6 border-t border-white/10 pt-8 text-sm">
            <div>
              <p className="font-display text-3xl font-semibold text-ink">08</p>
              <p className="mt-2 text-muted">Years running</p>
            </div>
            <div>
              <p className="font-display text-3xl font-semibold text-ink">04</p>
              <p className="mt-2 text-muted">Studio members</p>
            </div>
            <div>
              <p className="font-display text-3xl font-semibold text-accent">3am</p>
